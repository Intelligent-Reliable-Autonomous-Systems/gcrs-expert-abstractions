...
#   --scale <xy-scale>: set the scale of the environment, at least 1 (default 6)
...
python "${SCRIPT_DIR}/../gcrs/rpo_continuous_action.py" \
    --env-id cocogrid/ObjectDelivery-3-v0 \
    ...
    --log-dir "${SCRIPT_DIR}/../runs/ObjectDelivery-${SCALE}-${ABSTRACTION}" \
    --capture-video
